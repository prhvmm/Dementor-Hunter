...
public class Game extends JPanel implements ActionListener, KeyListener {
	...
	public Game(String name) {
		...
		this.gunHeight=140;
		this.gunWidth=300;
		gun = new Gun(WIDTH / 2 -(gunWidth/2), HEIGHT, gunWidth, gunHeight);
		Shot = new ArrayList<Shot>();
		Birds = new ArrayList<Birds>();
		Birds.add(new Birds(rnd.nextInt(WIDTH - 100), rnd.nextInt(10) + 25+ScorePanelHEIGHT, 100, 70, WIDTH, HEIGHT));
		Birds.add(new Birds(rnd.nextInt(WIDTH - 100), rnd.nextInt(35) + 35+ScorePanelHEIGHT, 100, 70, WIDTH, HEIGHT));
		Birds.add(new Birds(rnd.nextInt(WIDTH - 100), rnd.nextInt(70) + 75+ScorePanelHEIGHT, 100, 70, WIDTH, HEIGHT));
